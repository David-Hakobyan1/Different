...
width = 800#int(input("mutq width(x) "))
height = 600#int(input("mutq height(y) "))
cell = 60#int(input("mutq cell " ))
size = 36#int(input("mutq size(36 kam poqr tiv) "))
win = GraphWin("shaxmat", width, height)
color = "white"
